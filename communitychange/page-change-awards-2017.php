		...
		<div id="content" class="site-content change-awards" role="main">
			...
			<nav class="page">
		    	<ul class="clearfix">
					...
					<li><a href="#spirit-of-the-awards" class="page">Spirit of the Awards </a>
					<li><a href="#previous-year-honorees" class="page">Previous Years Honorees </a>
					<li><a href="#nominate-a-champion" class="page"> Nominate a Champion </a>
